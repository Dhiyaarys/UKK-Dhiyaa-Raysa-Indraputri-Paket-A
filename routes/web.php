...
Route::prefix('admin')->group(function () {
   ...
   Route::middleware(['isAdmin'])->group(function () {
      ...
      Route::get('cetak-pengaduan', [LaporanController::class, 'cetakPengaduan'])->name('try');
   });
   ...
   Route::middleware(['isPetugas'])->group(function () {
      ...
      Route::get('pengaduan-pending', [DashboardController::class, 'showPending'])->name('pending');
